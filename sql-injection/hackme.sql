...
INSERT INTO `members` VALUES (1,'dinos80152','abc');
...
-- Dump completed on 2015-09-09  1:45:07
-- MySQL dump 10.13  Distrib 5.6.24, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: hackme
-- ------------------------------------------------------
-- Server version	5.6.19-1~exp1ubuntu2
...
LOCK TABLES `members` WRITE;
/*!40000 ALTER TABLE `members` DISABLE KEYS */;
INSERT INTO `members` VALUES (1,'dinos80152','bcd');
/*!40000 ALTER TABLE `members` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sql_injection` VALUES (1,'Dino');
